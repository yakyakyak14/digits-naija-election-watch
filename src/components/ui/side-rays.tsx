...
export const SideRays = memo(function SideRays({ className, intensity = 1 }: SideRaysProps) {
  return (
    ...
    >
      {/* ----------------- TOP RIGHT RAYS ONLY ----------------- */}
      <div className="absolute -top-12 -right-12 w-[650px] h-[650px] sm:w-[850px] sm:h-[850px] lg:w-[1100px] lg:h-[1100px] opacity-75 dark:opacity-90 mix-blend-screen transition-opacity duration-700">
        {/* Soft Radial Ambient Glow */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-emerald-500/30 via-emerald-600/12 to-transparent blur-3xl" />
        ...
        <div
          ...
          style={{
            background: `conic-gradient(from 245deg at 100% 0%, 
              transparent 0deg, 
              rgba(0, 135, 81, ${0.2 * intensity}) 12deg, 
              transparent 22deg, 
              rgba(16, 185, 129, ${0.25 * intensity}) 35deg, 
              transparent 48deg, 
              rgba(212, 175, 55, ${0.16 * intensity}) 58deg, 
              transparent 72deg, 
              rgba(0, 135, 81, ${0.18 * intensity}) 84deg, 
              transparent 98deg)`,
            filter: "blur(20px)",
          }}
        />
      ...
      <div className="absolute top-0 right-0 w-1/2 h-px bg-gradient-to-l from-emerald-500/50 via-emerald-500/20 to-transparent" />
    </div>
  );
});
