...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DIGITS — Transparent Democracy for Nigeria" },
      { name: "description", content: "DIGITS is a citizen-powered digital transparency platform empowering Nigerian democracy through real-time election monitoring, trained observers, and verified reports." },
      { name: "author", content: "DIGITS" },
      { name: "theme-color", content: "#008751" },
      { property: "og:title", content: "DIGITS — Transparent Democracy for Nigeria" },
      { property: "og:description", content: "Real-time election monitoring by trained citizens (DIGEO). Live observer streams, verified incident reports, and transparent results." },
